...
def set_up_and_run_experiments(args_dict, files_of_cached_model_args, files_of_cached_data_args, POSSIBLE_MODEL_TYPES, POSSIBLE_DATA_SETS, shuffle_seed=0):
    ...
    print("set_up_and_run_experiments: pre-kick off args_dict == ", args_dict)
...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="DGCNN_d4IC_BLgs1Parsim_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    files_of_cached_model_args = [
        "DGCNN_d4IC_BLgs1Parsim_cached_args.txt",
    ]
