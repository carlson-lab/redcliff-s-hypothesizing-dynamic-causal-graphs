...
def kick_off_model_training_experiment(args_dict):
    ...
    args_dict["save_root_path"] = curr_run_save_dir
...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="DYNOTEARS_Vanilla_d4IC_BCNIBCHVgs1Parsim_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
