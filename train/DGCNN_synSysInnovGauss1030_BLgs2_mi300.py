...
def set_up_and_run_experiments(args_dict, files_of_cached_model_args, files_of_cached_data_args, POSSIBLE_MODEL_TYPES, POSSIBLE_DATA_SETS, shuffle_seed=0):
    ...
    print("set_up_and_run_experiments: WARNING - CHANGING num_classes PARAMETER TO MATCH CURRENT DATASET")
    if "_numSF1_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 1
    elif "_numSF2_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 2
    elif "_numSF3_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 3
    elif "_numSF4_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 4
    elif "_numSF5_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 5
    elif "_numSF6_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 6
    elif "_numSF7_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 7
    elif "_numSF8_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 8
    elif "_numSF9_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 9
    elif "_numSF10_" in args_dict["data_set_name"]:
        args_dict["num_classes"] = 10
    else:
        raise NotImplementedError()
    print("set_up_and_run_experiments: args_dict['num_classes'] == ", args_dict["num_classes"])
...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="DGCNN_synSysInnovGauss1030_BLgs2_mi300_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    files_of_cached_model_args = [
        "DGCNN_synSysInnovGauss1030_BLgs2_mi300_cached_args.txt",
    ]
