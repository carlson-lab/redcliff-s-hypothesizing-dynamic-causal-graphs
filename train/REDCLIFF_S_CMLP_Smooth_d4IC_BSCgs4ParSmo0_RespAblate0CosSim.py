...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="REDCLIFF_S_CMLP_Smooth_d4IC_BSCgs4ParSmo0_RespAblate0CosSim_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    files_of_cached_model_args = [
        "REDCLIFF_S_CMLP_Smooth_d4IC_BSCgs4ParSmo0_RespAblate0CosSim_cached_args.txt",
    ]
