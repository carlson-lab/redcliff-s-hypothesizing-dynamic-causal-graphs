...
def set_up_and_run_experiments(args_dict, files_of_cached_model_args, files_of_cached_data_args, POSSIBLE_MODEL_TYPES, POSSIBLE_DATA_SETS, shuffle_seed=0):
    ...
    print("set_up_and_run_experiments: **NOT** OVER-WRITING FACTOR_COS_SIM_COEFF TO SCALE WITH SELECTED DATASET")
...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="REDCLIFF_S_CMLP_Smooth_d4IC_BSCgs4ParSmo0_RespAblate1Fac_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    files_of_cached_model_args = [
        "REDCLIFF_S_CMLP_Smooth_d4IC_BSCgs4ParSmo0_RespAblate1Fac_cached_args.txt",
    ]
