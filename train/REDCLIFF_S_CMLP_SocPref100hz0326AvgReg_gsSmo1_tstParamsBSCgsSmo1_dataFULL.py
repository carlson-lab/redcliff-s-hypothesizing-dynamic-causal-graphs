...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="REDCLIFF_S_CMLP_SocPref100hz0326AvgReg_gsSmo1_tstParamsBSCgsSmo1_dataFULL_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    files_of_cached_model_args = [
        "REDCLIFF_S_CMLP_SocPref100hz0326AvgReg_gsSmo1_tstParamsBSCgsSmo1_dataFULL_cached_args.txt",
    ]

    POSSIBLE_DATA_SETS = [
        "socPref_100HzLP_fold0",
        "socPref_100HzLP_fold1",
        "socPref_100HzLP_fold2",
        "socPref_100HzLP_fold3",
        "socPref_100HzLP_fold4",
    ]
    files_of_cached_data_args = [
        "cached_dataset_args/socPref_100HzLP_fold0_cached_args.txt", 
        "cached_dataset_args/socPref_100HzLP_fold1_cached_args.txt", 
        "cached_dataset_args/socPref_100HzLP_fold2_cached_args.txt", 
        "cached_dataset_args/socPref_100HzLP_fold3_cached_args.txt", 
        "cached_dataset_args/socPref_100HzLP_fold4_cached_args.txt", 
    ]
    POSSIBLE_num_factors = [2,4,6,9,18,36] # OVER-WRITTEN TO MATCH SELECTED DATASET (ACCORDING TO TASK_ID)
    POSSIBLE_num_supervised_factors = [3,] # OVER-WRITTEN TO MATCH SELECTED DATASET (ACCORDING TO TASK_ID)
    # the above yields 6 possible setting combinations
