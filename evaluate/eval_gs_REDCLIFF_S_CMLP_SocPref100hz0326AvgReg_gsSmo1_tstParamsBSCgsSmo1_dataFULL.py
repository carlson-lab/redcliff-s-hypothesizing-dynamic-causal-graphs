...
if __name__=="__main__":
    ...
    parse.add_argument(
        "-cached_args_file",
        default="eval_gs_REDCLIFF_S_CMLP_SocPref100hz0326AvgReg_gsSmo1_tstParamsBSCgsSmo1_dataFULL_cached_args.txt", # WARNING: edit this line when running new experiments on SLURM server
    ...
    for model_key in model_summaries.keys():
        ...
        for fw_l1_penalty in curr_gc_fw_l1_penalty_summaries:
            model_summaries[model_key]["avg_fw_l1_penalty_history"].append(fw_l1_penalty)#curr_mean)
    ...
    for criteria_index, criteria_type in enumerate(selection_criteria):
        ...
        pearson_r_epoch_perf_avg = np.corrcoef(best_criteria_performance_by_model, best_epoch_by_model)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        ...
        pearson_r_rocAuc_avg = np.corrcoef(best_criteria_performance_by_model, corresponding_stopping_roc_auc_scores)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_rocAucOffDiag_avg = np.corrcoef(best_criteria_performance_by_model, corresponding_stopping_roc_auc_OffDiag_scores)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_rocAuc_avg_by_deltaCon0 = np.corrcoef(corresponding_stopping_avg_gc_factor_deltacon0_history, corresponding_stopping_roc_auc_scores)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_rocAucOffDiag_avg_by_deltaCon0 = np.corrcoef(corresponding_stopping_avg_gc_factor_deltacon0_history, corresponding_stopping_roc_auc_OffDiag_scores)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_DDdeltaCon0_avg_by_deltaCon0 = np.corrcoef(corresponding_stopping_avg_gc_factor_deltacon0_history, corresponding_stopping_avg_gc_factor_deltacon0_with_directed_degrees_history)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_deltafinity_avg_by_deltaCon0 = np.corrcoef(corresponding_stopping_avg_gc_factor_deltacon0_history, corresponding_stopping_avg_gc_factor_deltaffinity_history)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_deltaCon0_avg_by_epoch = np.corrcoef(best_epoch_by_model, corresponding_stopping_avg_gc_factor_deltacon0_history)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
        ...
        pearson_r_deltaCon0_avg = np.corrcoef(best_criteria_performance_by_model, corresponding_stopping_avg_gc_factor_deltacon0_history)[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
        fig1, ax1 = plt.subplots()
        fig1.set_size_inches(12.8, 9.6)
    ...
    for i, c1_key in enumerate(criteria_performance_dict.keys()):
        for j, c2_key in enumerate(criteria_performance_dict.keys()):
            if i < j:
                ...
                curr_pearson_r_score = np.corrcoef(criteria_performance_dict[c1_key]["best_criteria_performance_by_model"], criteria_performance_dict[c2_key]["best_criteria_performance_by_model"])[0,1] # see https://realpython.com/numpy-scipy-pandas-correlation-python/ and https://sebastianraschka.com/faq/docs/pearson-r-vs-linear-regr.html
                fig1, ax1 = plt.subplots()
                fig1.set_size_inches(12.8, 9.6)
